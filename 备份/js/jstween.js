...
(function(factory) {
      ...
      return typeof document === "undefined"
        ...
        : document.querySelectorAll
            ...
            : document.getElementById(
                target.charAt(0) === "#" ? target.substr(1) : target
              );
    } else {
      return target;
    }
  ...
  function regValue(value) {
    ...
    if (_a)
      return { num: fixed3(_a[2] + _a[3] + _a[4]), unit: _a[5], ext: _a[1] };
  ...
  function updateTransform(obj) {
    var _t = "";
    if (obj._jt_obj.perspective)
      _t += "perspective(" + obj._jt_obj.perspective + ") ";
    if (obj._jt_obj.x || obj._jt_obj.y || obj._jt_obj.z)
      _t +=
        "translate3d(" +
        checkNumber(obj._jt_obj.x) +
        "," +
        checkNumber(obj._jt_obj.y) +
        "," +
        checkNumber(obj._jt_obj.z) +
        ") ";
    if (obj._jt_obj.rotationX)
      _t += "rotateX(" + obj._jt_obj.rotationX % 360 + "deg) ";
    if (obj._jt_obj.rotationY)
      _t += "rotateY(" + obj._jt_obj.rotationY % 360 + "deg) ";
    if (obj._jt_obj.rotationZ)
      _t += "rotateZ(" + obj._jt_obj.rotationZ % 360 + "deg) ";
    if (
    ...
    if (obj._jt_obj.skewX || obj._jt_obj.skewY)
      _t += "skew(" + obj._jt_obj.skewX + "deg," + obj._jt_obj.skewY + "deg) ";
  ...
  extend(tween.prototype, {
    ...
    _update: function(time) {
      ...
      if (this.curTime < this.endTime) {
        ...
        var _time =
          (this.curTime - this.endTime) % (this.duration + this.repeatDelay);
    ...
    _updateProp: function() {
      var _elapsed = this.duration == 0
        ? 1
        : (this.curTime - this.startTime - this.repeatDelay) / this.duration;
  ...
  extend(JT, {
    ...
    call: function(time, callback, params, isPlaying) {
      return new tween(
        ...
        time,
        {},
        { onEnd: callback, onEndParams: params, isPlaying: isPlaying },
        false
      );
    }
  });
